...
import wordtool.ast.expression.CharacterMatchOption;
import wordtool.ast.expression.FollowedByExpression;

import java.util.regex.Matcher;

public class FollowedByParser implements WordGenParser.ExpressionParser<FollowedByExpression> {

	@Override
	public FollowedByExpression parse(Matcher matcher, String expression) {
		if (matcher.groupCount() == 1) {
			...
			return new FollowedByExpression(option);
		}		
		return null;
	}
