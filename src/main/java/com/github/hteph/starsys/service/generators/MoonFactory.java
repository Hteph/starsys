...
import com.github.hteph.starsys.service.objects.OrbitalFacts;
import com.github.hteph.starsys.service.objects.Planet;
import com.github.hteph.starsys.service.objects.Star;
...
import com.github.hteph.starsys.service.tables.TableMaker;
...
public final class MoonFactory {
    ...
    public static Planet generate(
        ...
        //density
        final double density = PlanetaryUtils.getDensity(orbitDistance, centralStar, SNOWLINE);
        ...
        tectonicActivityGroup = PlanetaryUtils.getTectonicActivityGroup(centralStar, tidalForce, mass);
        ...
        hydrosphere = MakeAtmosphere.findTheHydrosphere(hydrosphereDescription, moonRadius);
        ...
        var albedo = PlanetaryUtils.findAlbedo(IS_INNER_ZONE, atmoPressure, hydrosphereDescription, hydrosphere);
        ...
        MakeAtmosphere.checkHydrographics(hydrosphereDescription,
                                          hydrosphere,
                                          atmoPressure,
                                          moonBuilder,
                                          surfaceTemp,
