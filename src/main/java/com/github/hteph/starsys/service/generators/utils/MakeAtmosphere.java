...
public class MakeAtmosphere {
        ...
        if (atmoMap.containsKey("CO2")) {
            ...
            if (maxGas.isPresent()) {
                ...
                if (gas.getPercentageInAtmo() < oxygenMax) {
                    oxygenPercentage = gas.getPercentageInAtmo();
                    atmoMap.put("O2", AtmosphericGases.builder()
                                                      .name("O2")
                                                      .percentageInAtmo(oxygenPercentage)
                                                      .build());
                    ...
                    atmoMap.put(gas.getName(), AtmosphericGases.builder()
                                                               .name("O2")
                                                               .percentageInAtmo(gas.getPercentageInAtmo() - oxygenMax)
                                                               .build());
                }
            }
        }
    ...
    public static int findTheHydrosphere(HydrosphereDescription hydrosphereDescription, int radius) {
        ...
        } else if (hydrosphereDescription.equals(HydrosphereDescription.CRUSTAL)) {tempHydro = 100;} else if (hydrosphereDescription.equals(
                HydrosphereDescription.REMNANTS)) {tempHydro = Dice.d6() / 2;}
