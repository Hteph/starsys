...
import com.github.hteph.starsys.enums.AttributeEnum;
import com.github.hteph.starsys.enums.EnvironmentalEnum;
import com.github.hteph.starsys.enums.TrophicLevels;
...
public class DietTable {
    ...
    public static void findTrophicLevel(Creature lifeform, EnvironmentalEnum environ) {
        ...
        if (lifeform.getThrophicLevel() == null) {
            setTrophicLevel(lifeform, environ, bonus);
        }
    ...
    private static void setTrophicLevel(Creature lifeform, EnvironmentalEnum environ, int bonus) {
...
//TODO switch the random calc to dice based
        ...
        switch (environ) {
            case COASTAL, RIVER_AND_STREAM, LAKES, ESTUARIES, REEFS, INTERTIDAL_AND_LITTORAL -> {
            ...
            case ALPINE -> lifeform.setThrophicLevel(TableMaker.makeRoll(
                    Dice._3d6(),
                    new int[]{1, 11, 14, 18},
                    TROPHIC_LEVELS)
            );
            case TUNDRA -> {
                if (lifeform.hasAttribute("Swimmer") || lifeform.hasAttribute("Amphibious")) {
                    bonus += -2;
                }
                lifeform.setThrophicLevel(TableMaker.makeRoll(
                        Dice._3d6() + bonus,
            ...
            case TEMPERATE_FORESTS, RAIN_FOREST, CONIFEROUS_FORESTS -> {
                if (lifeform.hasAttribute("Flier")) {
                    bonus += -2;
                }
                lifeform.setThrophicLevel(TableMaker.makeRoll(
            ...
            case GRASSLANDS, TROPICAL_SAVANNAS, HEATHLANDS, SHRUBLANDS -> {
                if (lifeform.hasAttribute("Flier")) {
                    bonus += -3;
                }
                lifeform.setThrophicLevel(TableMaker.makeRoll(
            ...
            case DESERT, TEMPERATE_AND_SEMI_DESERTS -> {
                if (lifeform.hasAttribute("Swimmer") || lifeform.hasAttribute("Amphibious")) {
                    bonus += -3;
                }
                if (lifeform.hasAttribute("Burrower")) {
                    bonus += 1;
                }
                if (lifeform.hasAttribute("Flier")) {
                    bonus += -3;
            ...
            case BIOINDUSTRIAL, GREENHOUSE, TREE_CROP, FIELD_CROP, MANAGED_GRASSLANDS, MANAGED_AQUATIC, CAVE -> lifeform.setThrophicLevel(TableMaker.makeRoll(
                    Dice._3d6(),
                    new int[]{3, 10, 14, 15},
                    TROPHIC_LEVELS)
            );
            case DEEP_OCEAN, SHELVES -> {
                if (lifeform.getAttributes().containsKey("Thermal Vent")) {
                    bonus += 3;
                }
                if (lifeform.hasAttribute("Flier")) {
                    bonus += -1;
            ...
            case EXOTIC -> lifeform.setThrophicLevel(AUTOTROPH);
            default -> lifeform.setThrophicLevel(OMNIVORE);
        }
    }
    ...
    private static void findHerbivoreSpeciality(Creature lifeform) {
        ...
        if (lifeform.hasAttribute("Swimmer")) {
            bonus += 1;
        }
        if (lifeform.hasAttribute("Plains Dweller")) {
            bonus -= 2;
        }
        if (lifeform.hasAttribute("Forest Dweller")) {
            bonus += 1;
        }
        ...
        switch (speciality) {
            case "Gathering":
                ...
                if (Dice.betweenOrEqual3d6(6, 7)) {
                    lifeform.addAttribute(AttributeEnum.CONCENTRATION, -1);
                }
                if (Dice._3d6(7)) {
                    lifeform.addAttribute(AttributeEnum.CURIOSITY);
                }
                if (Dice._3d6(7)) {
                ...
                if (Dice._3d6(9)) {
                    lifeform.addAttribute(AttributeEnum.TASTE);
                }
                break;
            case "Saprophytic":
                lifeform.addAttribute("Saprophytic",
                                      "A creature who live off of the chemical decompositions of rotting flesh and vegetable matter. Saprophytosis yields little energy, and saprophytes spend a great deal of time squatting in piles of carrion and compost. On the positive side, their 'food' need not be of very high quality.");
                lifeform.addAttribute(AttributeEnum.CONCENTRATION, -1);
                ...
                if (Dice.betweenOrEqual3d6(3, 10)) {
                    lifeform.addAttribute(AttributeEnum.SMELL);
                }
                if (Dice.betweenOrEqual3d6(3, 12)) {
                    ...
                    lifeform.addAttribute("Unversial Digestion",
                                          "Through exotic metabolism components anything containing the basic atoms of life can be used for food for this species.");
                }
            ...
            case "Grazing":
                ...
                lifeform.addAttribute(AttributeEnum.IMAGINATION, -1);
                if (Dice.betweenOrEqual3d6(3, 10)) {
                    lifeform.addAttribute(AttributeEnum.SUSPICION);
                }
                if (Dice.betweenOrEqual3d6(3, 10)) {
                    lifeform.addAttribute(AttributeEnum.EMPATHY, -1);
                }
    ...
    private static void findErgivoreSpeciality(Creature lifeform) {
        ...
        if (lifeform.hasAttribute("Thermal Vent")) {
            bonus += 4;
        }
        if (lifeform.hasAttribute("Arctic")) {
            bonus += 1;
        }
        ...
        switch (choice) {
            case "Tapper":
                ...
                lifeform.addAttribute(AttributeEnum.IMAGINATION);
                lifeform.addAttribute("Dependency",
                                      "The tapper consumes modest amounts of food to obtain minerals and fluids but must tap into an energy source for at least 24 hours once per week.");
                ...
                break;
            case "Rooted":
                lifeform.addAttribute("Rooted Ergivore",
                                      "They use energy (e.g., sunlight, microwaves, etc.) to process minerals, water and organic chemicals into food. May be mobile, but are slow.");
                if (Dice.betweenOrEqual3d6(3, 8)) {
                    lifeform.addAttribute(AttributeEnum.IMAGINATION, -1);
                }
                if (Dice.betweenOrEqual3d6(3, 8)) {
                    lifeform.addAttribute(AttributeEnum.SUSPICION, -1);
                }
                if (Dice.betweenOrEqual3d6(3, 8)) {
                    lifeform.addAttribute(AttributeEnum.CHAUVINISM, -1);
                }
                if (Dice.betweenOrEqual3d6(3, 8)) {
                    lifeform.addAttribute(AttributeEnum.EMPATHY, -1);
                }
            ...
            case "Mixed":
                ...
                break;
            case "Pure":
                lifeform.addAttribute("Pure Ergivore",
                                      "They depend on energy for the life processes. They still need nutrietns and building material for growth and healing, but only a limited amount of non energy sustenance for everyday needs.");
    ...
    private static void findOmnivoreSpeciality(Creature lifeform) {
        ...
        if (lifeform.hasAttribute("Amphibian")) {
            bonus += 2;
        }
        if (lifeform.getHabitat().equals(EnvironmentalEnum.MIRES)) {
            bonus -= 2;
        }
        ...
        switch (choice) {
            ...
            case "Opportunist Browser":
                ...
                if (Dice.betweenOrEqual3d6(3, 8)) {
                    lifeform.addAttribute(AttributeEnum.TASTE, 2);
                }
                if (Dice.betweenOrEqual3d6(3, 8)) {
                    lifeform.addAttribute("Cast Iron Stomach", "Can eat or drink almost anything without getting sick.");
                }
    ...
    private static void findCarnivoreSpeciality(Creature lifeform) {
        ...
        switch (choice) {
            case "Stalker":
                lifeform.addAttribute("Stalker",
                                      "Stalking carnivores stealthily track down a single animal. They are very adaptable, and may use the tactics of a chaser or pouncer.");
                lifeform.addAttribute(AttributeEnum.IMAGINATION);
                ...
                if (Dice.betweenOrEqual3d6(3, 10)) {
                    lifeform.addAttribute(AttributeEnum.EMPATHY);
                }
                if (Dice.betweenOrEqual3d6(3, 10)) {
                ...
                if (Dice.betweenOrEqual3d6(3, 12)) {
                    lifeform.addAttribute(AttributeEnum.VOICE, 4);
                }
                if (Dice.betweenOrEqual3d6(3, 8)) {
                    lifeform.addAttribute(AttributeEnum.CONSTITUTION, 2);
                }
                ...
                break;
            case "Chaser":
                lifeform.addAttribute("Chasers",
                                      "Prowl about for prey. When they find a target, they use a burst of speed to catch it. Chasers occasionally cooperate to bring down game. ");
                lifeform.addAttribute(AttributeEnum.MOVEMENT, 2);
                if (Dice.betweenOrEqual3d6(3, 12)) {
                    lifeform.addAttribute("Tracker", "The species senses are routed for percive tracks and traces.");
                }
                ...
                if (Dice.betweenOrEqual3d6(3, 10)) {
                    lifeform.addAttribute(AttributeEnum.STAMINA, 4);
                }
                if (Dice.betweenOrEqual3d6(3, 8)) {
                    lifeform.addAttribute(AttributeEnum.STEALTH);
                }
                break;
            case "Scavenger":
                lifeform.addAttribute("Carrion Scavenger",
            ...
            case "Pouncer":
                ...
                if (Dice.betweenOrEqual3d6(3, 6 + trapperBonus)) {
                    lifeform.addAttribute("Trappers",
                                          "Build physical traps to snare prey.Trappers rarely stray far from their lairs, but are very strong and/or venomous, in order to quickly subdue struggling prey.");
                    lifeform.addAttribute("Alertness",
                    ...
                    if (Dice.betweenOrEqual3d6(3, 6)) {
                        lifeform.addAttribute("Webbing",
                                              "The lifeform produces a material that can be used for creating webs (for traps) or threads for movement or prey restriction.");
                    }
                } else {
                    lifeform.addAttribute("Pouncers",
                                          " Lie in wait in trees, on high rocks, or hide themselves in foliage.When a likely victim comes by, they leap fromhiding and tackle their prey. ");
                    lifeform.addAttribute(AttributeEnum.CONCENTRATION);
                    if (Dice.betweenOrEqual3d6(3, 8)) {
                    ...
                    if (Dice.betweenOrEqual3d6(3, 8)) {
                        lifeform.addAttribute(AttributeEnum.AUDIO);
                    }
                    if (Dice.betweenOrEqual3d6(3, 6)) {
                        lifeform.addAttribute(AttributeEnum.VOICE, 4);
                    }
                ...
                break;
            case "Herder":
                lifeform.addAttribute("Herders",
                                      "These are similar to chasers, but they usually work in groups, against groups, using \"teamwork\" to single out a weak prey animal from its herd. ");
                if (Dice.betweenOrEqual3d6(3, 6)) {
                    lifeform.addAttribute(AttributeEnum.EMPATHY);
                }
                lifeform.addAttribute(AttributeEnum.MOVEMENT);
                if (Dice.betweenOrEqual3d6(3, 8)) {
                    lifeform.addAttribute(AttributeEnum.INTELLIGENCE);
                }
                if (Dice.betweenOrEqual3d6(3, 8)) {
                    lifeform.addAttribute(AttributeEnum.VOICE, 4);
                }
                if (Dice.betweenOrEqual3d6(3, 6)) {
                    lifeform.addAttribute(AttributeEnum.GREGARIOUSNESS);
                }
                if (Math.random() < 0.3) {
                    lifeform.addAttribute("Tracker", "The species senses are routed for percive tracks and traces.");
                }
