...
import com.github.hteph.starsys.service.generators.utils.LifeMethods;
...
import static com.github.hteph.starsys.service.generators.utils.MakeAtmosphere.checkHydrographics;
import static com.github.hteph.starsys.service.generators.utils.MakeAtmosphere.findGreenhouseGases;
...
public final class TerrestrialPlanetFactory {
    ...
    public static Planet generate(
        ...
        //density
        final double density = PlanetaryUtils.getDensity(orbitDistance, star, SNOWLINE);
        ...
        tectonicCore = PlanetaryUtils.findTectonicGroup(IS_INNER_ZONE, density);
        tectonicActivityGroup = PlanetaryUtils.getTectonicActivityGroup(star, tidalForce, mass);
        
        var magneticField = PlanetaryUtils.getMagneticField(
            rotationalPeriod,
            tectonicCore,
        ...
        //Atmoshperic details
        atmosphericComposition = MakeAtmosphere.createPlanetary(
            star,
            baseTemperature,
            tectonicActivityGroup,
            planetRadius,
        ...
        double atmoPressure = FindAtmoPressure.calculate(
            tectonicActivityGroup,
            hydrosphere,
        ...
        albedo = PlanetaryUtils.findAlbedo(IS_INNER_ZONE, atmoPressure, hydrosphereDescription, hydrosphere);
        ...
        //Bioshpere
        double greenhouseFactor = findGreenhouseGases(
            atmosphericComposition,
            atmoPressure,
            baseTemperature,
        ...
        int surfaceTemp = TempertureMethods.getSurfaceTemp(
            baseTemperature,
            atmoPressure,
            greenhouseFactor
        );
        ...
        var temperatureFacts = TempertureMethods.setSeasonalTemperature(
            atmoPressure,
            hydrosphere,
            rotationalPeriod,
            axialTilt,
        ...
        temperatureFacts.eccentricityVariation(TempertureMethods.setExcentricityVariation(
            eccentricity,
        ...
        TempertureMethods.setDayNightTemp(
            temperatureFacts,
            baseTemperature,
...
//Sanity check of water
        ...
        if (hasGaia) {
            ...
            planetBuilder.life(biosphere.homeworld(homeworld.build()).build());
        }
