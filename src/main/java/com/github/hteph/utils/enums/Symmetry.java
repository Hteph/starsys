...
public enum Symmetry implements baseEnum{
    ...
    NONE("No symmetry","The lifeform lacks any symmetry in placement of bodyStructure and organ locations. This makes it difficult to aim for vitals.",0),
    BILATERAL("Bilateral","Has two \"sides\" that structurally mirrors each other",2),
